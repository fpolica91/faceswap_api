...
def create_video(target_path: str, fps: float = 30) -> bool:
    ...
    commands = ['-hwaccel', 'auto', '-r', str(fps), '-i', os.path.join(
        temp_directory_path, '%04d.' + roop.globals.temp_frame_format), '-c:v', roop.globals.output_video_encoder]
    ...
    commands.extend(['-pix_fmt', 'yuv420p', '-vf',
